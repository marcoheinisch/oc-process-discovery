...
sap_conn_params = {
    'user': '', # your SAP username here
    'passwd': '', # your SAP password here
...
tables = {
    ...
    # o2c ,
    'VBAK': [0, "VBELN", "ERDAT", "ERZET"],
    'BKPF': [4, 'MANDT', 'BUKRS', 'BELNR', 'GJAHR', 'BLART', 'BLDAT', 'BUDAT', 'MONAT', 'CPUDT', 'CPUTM', 'WWERT', 'TCODE', 'BVORG', 'XBLNR', 'DOCCAT'],
    'VBFA': [0, "ERDAT", "ERZET", "VBELN", "VBELV", "VBTYP_N", "VBTYP_V", "RFMNG","MEINS", "RFWRT", "WAERS", "MATNR", "BWART", "VRKME", "FKTYP", "POSNN", "POSNV"],      # explains the status of objects that are associated with the o2c process / flow table
}
